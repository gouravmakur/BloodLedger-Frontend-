...
const Header = () => {
    ...
    <>
        <nav className='navbar bg-light'>
            ...
            <div className="navbar-brand h1 d-flex align-items-center">
             <img src="/assets/navlogo.png" alt="Logo" className="img-fluid align-center" style={{ width: "120px", height: "70px" }} />
            </div>
